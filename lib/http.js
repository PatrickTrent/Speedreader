...
function main() {
  ...
  if (configError) {
    console.error(`REFUSING TO START: ${configError}. DATA_DIR must be a persistent volume outside the deploy directory, IP_HASH_SECRET must be set, and production must set ORIGIN_SECRET or DIRECT_CLOUDFLARE_ORIGIN=1.`);
    process.exit(1);
  }
